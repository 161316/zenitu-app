...
export const DICTIONARY: DictionaryWord[] = [
  ...
  },
  {
    ...
    example: "O CTO do Nubank decide quais linguagens de programação usar, como proteger os dados de 85 milhões de clientes e quais tecnologias de IA adotar para melhorar a experiência do app.",
